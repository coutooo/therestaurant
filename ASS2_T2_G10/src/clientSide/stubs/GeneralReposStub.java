...
public class GeneralReposStub
{
   ...
   *
   *     @param value number of portions delivered
   */
    ...
    public void setnPortions(int value) 
    {
        ...
        outMessage = new Message (MessageType.STNP, value);
        com.writeObject (outMessage);
        inMessage = (Message) com.readObject ();
   ...
   */
    ...
    public void setnCourses(int value) 
    {
        ...
        outMessage = new Message (MessageType.STNC, value);
        com.writeObject (outMessage);
        inMessage = (Message) com.readObject ();
        if (inMessage.getMsgType() != MessageType.)
           { GenericIO.writelnString ("Thread " + Thread.currentThread ().getName () + ": Invalid message type!");
   ...
   *
   *     @param value0 number of students at the restaurant
   *     @param value1 student id
   */
    
    public void updateSeatsAtTable(int value0, int value1)
    {
        ClientCom com;                                                 // communication channel
        Message outMessage,                                            // outgoing message
                inMessage;                                             // incoming message
        ...
        outMessage = new Message (MessageType.USAT, value0,value1);
        com.writeObject (outMessage);
        inMessage = (Message) com.readObject ();
        if (inMessage.getMsgType() != MessageType.)
           { GenericIO.writelnString ("Thread " + Thread.currentThread ().getName () + ": Invalid message type!");
