...
public class ServerRestaurantKitchen {
     ...
     * Main method.
     *
     * args[0] - port number for listening to service requests args[1] - name of
     * the platform where is located the RMI registering service args[2] - port
     * number where the registering service is listening to service requests
     */
    public static void main(String[] args) {
        ...
        Kitchen kitchen = new Kitchen(reposStub);             // kit object
        KitchenInterface kitchenStub = null;                   // remote reference to the kit object
