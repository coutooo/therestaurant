...
public class Kitchen implements KitchenInterface
{
    ...
    {
            //Set chef state
            reposStub.setChefState(ChefState.WAITING_FOR_AN_ORDER);
            ...
            return ChefState.WAITING_FOR_AN_ORDER;
    }
    ...
    public synchronized int startPreparation() throws RemoteException
    {
            ...
            reposStub.setnCourses(numberOfCoursesDelivered+1, ChefState.PREPARING_THE_COURSE);

            //Notify Waiter that the preparation of the order has started
            notifyAll();

            return ChefState.PREPARING_THE_COURSE;
    }
    ...
    public synchronized int proceedPreparation() throws RemoteException
    {
            ...
            reposStub.setnPortions(numberOfPortionsPrepared, ChefState.DISHING_THE_PORTIONS);

            //Update numberOfPortionsReady
            numberOfPortionsReady++;

            return ChefState.DISHING_THE_PORTIONS;
    }
    ...
    public synchronized int continuePreparation() throws RemoteException
    {
            ...
            reposStub.setnPortionsAndCourses(numberOfPortionsPrepared, numberOfCoursesDelivered+1,ChefState.PREPARING_THE_COURSE);
    ...
    public synchronized int cleanUp() throws RemoteException
    {
            ...
            reposStub.setChefState(ChefState.CLOSING_SERVICE);
            return ChefState.CLOSING_SERVICE;
    }
    ...
    {
            //Update waiter state
            reposStub.setWaiterState(WaiterState.PLACING_THE_ORDER);
            ...
            return WaiterState.PLACING_THE_ORDER;
    }
    ...
    {
            reposStub.setWaiterState(WaiterState.WAITING_FOR_PORTION);
            ...
            return WaiterState.WAITING_FOR_PORTION;
    }
